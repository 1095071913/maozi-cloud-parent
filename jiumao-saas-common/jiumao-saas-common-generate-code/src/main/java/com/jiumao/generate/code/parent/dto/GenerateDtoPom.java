...
package com.jiumao.generate.code.parent.dto;
...
public class GenerateDtoPom {
	...
	public static void generate(String module,String pash) throws Exception {
		...
		String context = "<project xmlns=\"http://maven.apache.org/POM/4.0.0\"\r\n" + 
				...
				"		<dependency>\r\n" + 
				"			<groupId>com.jiumao</groupId>\r\n" + 
				"			<artifactId>jiumao-saas-dto</artifactId>\r\n" + 
				"			<version>${jiumao-saas-dto.version}</version>\r\n" + 
				"			<type>pom</type>\r\n" + 
				"		</dependency>\r\n" + 
				"\r\n" + 
				"		<dependency>\r\n" + 
				"			<groupId>com.jiumao</groupId>\r\n" + 
				"			<artifactId>jiumao-saas-"+module+"-enum</artifactId>\r\n" + 
				"			<version>${jiumao-saas-"+module+"-enum.version}</version>\r\n" + 
				"		</dependency>\r\n" + 
