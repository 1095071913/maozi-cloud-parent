...
public class GenerateServiceImpl {
	...
	private static void entityImport(StringBuilder entity, String entityClass,String module,String childModule) {
		...
		entity.append("import com.jiumao"+"."+module+"."+childModule+".mapper"+entityName.replace("Do", "Mapper")+";\r\n");
		entity.append("import com.jiumao"+"."+module+"."+childModule+".api"+entityName.replace("Do", "Service")+";\r\n");
