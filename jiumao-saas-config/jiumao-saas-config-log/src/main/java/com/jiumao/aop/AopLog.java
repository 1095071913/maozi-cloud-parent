...
import com.jiumao.log.LogUtils;
...
public class AopLog extends BaseResultFactory {
	...
	private final static String LogPonit = "execution(com.jiumao.factory.result.AbstractBaseResult com.jiumao.*.*.api.impl..*Rpc*.*(..)) || execution(com.jiumao.factory.result.AbstractBaseResult com.jiumao.*.*.api.impl..*Rest*.*(..))";
