...
public class BaseResultFactory<T extends AbstractBaseDomain> implements Serializable {
	...
	static {
		codeDatas.put("mountain-shop-base-code", new CodeHashMap("mountain-shop-base-code",0) {{
			...
			this.put(new CodeAttribute(600,fuseMessage));
	...
	public static CodeAttribute code(Integer code) {
		...
		CodeAttribute baseCodeData = codeDatas.get("mountain-shop-base-code").get(code);
