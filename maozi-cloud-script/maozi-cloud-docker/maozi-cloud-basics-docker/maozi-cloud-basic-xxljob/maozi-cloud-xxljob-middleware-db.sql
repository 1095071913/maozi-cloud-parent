...
DROP DATABASE IF EXISTS `maozi-cloud-xxljob-middleware-db`;
CREATE DATABASE `maozi-cloud-xxljob-middleware-db` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `maozi-cloud-xxljob-middleware-db`;
