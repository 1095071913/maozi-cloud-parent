...
# ============================================================
# 父工程构建入口
# 对应 bat 版: maozi-cloud-bat/maozi-cloud-parent-build/maozi-cloud-parent-build.bat
# ------------------------------------------------------------
# 流程: 记录脚本目录 -> 读取目标源码路径 -> 切换到源码目录 -> 调用 jar-utils 执行构建
# 目标源码路径存放在同目录 maozi-cloud-parent-directory 文件中
# ============================================================
...
maozi_cloud_parent_directory="$(tr -d '\r' < maozi-cloud-parent-directory)"
