...
# ============================================================
# 基础服务构建入口
# 对应 bat 版: maozi-cloud-bat/maozi-cloud-basics-build/maozi-cloud-basics-build.bat
# ------------------------------------------------------------
# 流程: 记录脚本目录 -> 读取目标源码路径 -> 切换到源码目录 -> 调用 jar-utils 执行构建
# 目标源码路径存放在同目录 maozi-cloud-basics-directory 文件中
# ============================================================
...
maozi_cloud_basics_directory="$(tr -d '\r' < maozi-cloud-basics-directory)"
