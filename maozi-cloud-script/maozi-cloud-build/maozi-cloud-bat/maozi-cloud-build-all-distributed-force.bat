...
REM ------------------------------------------------------------
REM 与 maozi-cloud-build-all-distributed.bat 的区别:
...
call "%current_directory%\maozi-cloud-render-image.bat" render_and_build_image "!pj_service_name!" "!pj_module_dir!"
