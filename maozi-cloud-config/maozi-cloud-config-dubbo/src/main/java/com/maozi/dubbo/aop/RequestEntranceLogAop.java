...
public class RequestEntranceLogAop {
	...
	public Map<String, String> requestLog(ProceedingJoinPoint proceedingJoinPoint,HttpServletRequest request,String url) {
		...
		logs.put(LogTag.IP, isHttp ? WebUtil.getRequestHost(request) : url);
