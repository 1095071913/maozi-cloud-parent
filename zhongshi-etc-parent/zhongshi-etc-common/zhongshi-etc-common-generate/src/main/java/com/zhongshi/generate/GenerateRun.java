...
public class GenerateRun {
	...
	public static void generate(String module,String packageName, String pash) throws Exception {
			...
			service.append("package " + packageName.substring(0,packageName.lastIndexOf(".")) + ";\r\n");
			...
			service.append("		ApplicationRun(UserApplication.class);\r\n");
			service.append("	}\r\n\r\n");
			
			service.append("\r\n}");

			/* 创建文件 Begin */
			SQLType.fileCreate(pash+"\\"+packageName.substring(0,packageName.lastIndexOf(".")).replace(".", "\\"), module + "Application", service);
			/* 创建文件 End */
