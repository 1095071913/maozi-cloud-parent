...
import com.zhongshi.tool.UserAgentUtils;
...
//	private KafkaSender<JSONObject> kafkaSender;
	...
	@Pointcut("execution(* com.zhongshi.*.api.impl.*.*(..))")
	...
	public AbstractBaseResult doBefore(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
		...
		Future<StringBuilder> logBeforeFutrue = logBefore(proceedingJoinPoint,requestAttributes,id);
	...
	@Async
	private Future<StringBuilder> logBefore(ProceedingJoinPoint proceedingJoinPoint,ServletRequestAttributes requestAttributes,Long id) {
		...
		return new AsyncResult<StringBuilder>(printLog);
	}
	
	
//	@Async
//	private Future<AbstractBaseResult> logEnd( AbstractBaseResult<?> resultData){
//		StackTraceElement stackTraceElement=null;
//		String returnDate = null;
//	}
